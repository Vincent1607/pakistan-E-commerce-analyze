...
def load_csv_to_postgres():
    ...
    df = pd.read_csv('/opt/airflow/dags/P2M3_vincent_kaunang_data_raw.csv')
...
def ambil_data():
    ...
    df.to_csv('/opt/airflow/dags/P2M3_vincent_kaunang_data_new.csv', sep=',', index=False)
...
def preprocessing(): 
    ...
    '''
    # pembisihan data
    data = pd.read_csv("/opt/airflow/dags/P2M3_vincent_kaunang_data_new.csv")
    ...
    data.to_csv('/opt/airflow/dags/P2M3_vincent_kaunang_data_clean1.csv', index=False)
